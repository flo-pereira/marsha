...
describe('<RedirectOnLoad />', () => {
  ...
  it('redirects users to /dashboard when video is not ready to be shown and it has permissions to upadte it', () => {
    mockState = appState.SUCCESS;
    mockVideo = {
  ...
  it('redirects users to /dashboard when document is not ready to be shown and it has permissions to upadte it', () => {
    mockState = appState.SUCCESS;
    mockDocument = {
      is_ready_to_show: false,
      upload_state: uploadState.PROCESSING,
